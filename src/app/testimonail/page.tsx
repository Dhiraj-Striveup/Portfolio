...
const page = () => {
  ...
  <span className="block text-sm text-gray-400 uppercase mb-2">
    Testimonials
  </span>

  <span className="block min-h-[60px] md:min-h-[80px] bg-gradient-to-r from-cyan-400 to-white bg-clip-text text-transparent italic">
    <Typewriter
